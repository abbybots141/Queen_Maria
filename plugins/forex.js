...
// Command for fetching the latest forex news
smd(
  {
    pattern: "forex1",
    category: "forex",
...
// Command for fetching the current status of the forex market
smd(
  {
    pattern: "fxstatus",
    category: "forex",
...
// Command for fetching a list of active forex currency pairs
smd(
  {
    pattern: "fxpairs",
    category: "forex",
...
// Command for fetching foreign exchange rates against the US Dollar
smd(
  {
    pattern: "fxexchange",
    category: "forex",
...
// Command for fetching a list of active stock tickers
smd(
  {
